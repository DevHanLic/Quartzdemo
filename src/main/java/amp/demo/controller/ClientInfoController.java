...
public class ClientInfoController {
    ...
    void testInsert(@RequestBody ResultData resultData) {
        userTestService.insetUserTest(resultData.getUserTestList());
    }

    @PostMapping("/test/Update")
    void testUpdate(@RequestBody ResultData resultData) {
        userTestService.updateUserTest(resultData.getUserTestList());
    }
